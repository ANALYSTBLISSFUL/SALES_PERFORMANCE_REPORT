...
- Develop an interactive dashboard for monitoring sales performance.
- Analyze revenue, profit, COGS, and profit margin.
- Identify the most profitable products.
- Evaluate the performance of individual sales representatives.
- Compare operational costs across cities.
- Analyze profitability by customer type.
- Enable dynamic filtering for better business analysis.
- Provide data-driven recommendations to improve business performance.

### Dataset Description

The dataset contains 2,098 retail sales transactions recorded between January and May 2025. It includes information on products, revenue, profit, COGS, customer type, sales representatives, sales channels, regions, and cities. The dataset was cleaned and transformed in Excel before being used for analysis and dashboard development.
...
- Profit by Product
- COGS by City
- Monthly Profit by Customer Type
